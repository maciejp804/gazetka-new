    ...
    <div class="h-t-products1 section-t-padding section-b-padding">
        <div class="container">
            <div class="row space-between desktop-only">
                ...
                <div class="col-7 d-flex space-between">
                ...
                <div class="col-6 mt-3x big-blue-user fixed-height"><span class="white-cont">10.05.2022</span>
                ...
                <div class="col-3x mt-3"><img class="imageq" src="{{asset('assets/image/pro/mercao2.png')}}">
                    <p class="fast-p">10.05.2022</p>
                    <h2 class="card-title">Lorem ipsum dolor sit amet consectetur</h2><span class="paragraphCard">Consectetur adipiscing elit. Ut posuere, urna nec vehicula. Nullam vitae venenatis tortor. </span>
                ...
                <div class="col-6 mt-3x fixed-height"><img src="{{asset('assets/image/pro/mujercest.png')}}" class="w-100"></div>
                <div class="col-6 mt-3x big-bluew fixed-height"><span class="white-cont">10.05.2022</span>
