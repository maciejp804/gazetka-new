<section class="h-t-products1 first-section">
    <div class="container cont_set">
        <div class="row">
            <div class="section-title3 desktop-only"><h2 class="h2_7267fp"><span>Najnowsze gazetki promocyjne</span></h2>
                <h2 class="desktop-only h2_io1e0s">

                    <a class="more-link" href="/promotions/">Zobacz więcej</a>
                    ...
                    @foreach($leaflets as $leaflet)
                        <div class="items w-set">
                            ...
                            <div class="caption text-center">
                                ...
                                <div class="pro-price div_7qkpqa"><span class="old-price">GAZETKA {{ strtoupper($leaflet->store->name) }} </span></div>
                            </div>
                            <div class="icon-bgs">
                                <a href="javascript:pt_share(`http://165.232.144.14//promotion/{{ $leaflet->slug }}/`);"><i
                                        class="fa fa-pinterest-p icon-bg"></i></a>
                                <a href="javascript:fb_share(`http://165.232.144.14//promotion/{{ $leaflet->slug }}/`);"><i
                                        class="fa fa-facebook-f icon-bg"></i></a>
                                <a href="javascript:tw_share('sample promotion19', `http://165.232.144.14//promotion/{{ $leaflet->slug }}/`)"><i
...
<div class="all-blog text-center mt-4 mob-only"><a href="/promotions/" class="btn btn-style1 a_o8xtjv">Zobacz więcej</a></div>
